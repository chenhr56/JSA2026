...
public abstract class ValueVisitor<Result> {
	...
	public Result visit(Value v) {
		...
		case INT:
			return onInt((Value.Int) v);
		case REAL:
			return onReal((Value.Real) v);
		case NOMINAL:
			return onNominal((Value.Nominal) v);
		default:
			throw new IllegalStateException("Unknown ValueType:" + v.getType());
		}
	}
	...
	public static final class NumberVisitor extends ValueVisitor<Number> {
		...
		protected Number onNominal(Value.Nominal v) {
			return Integer.valueOf(v.getIndex());
		}
	}

	///////////////////////////////

	public static final class ValueStringVisitor extends ValueVisitor<String> {
