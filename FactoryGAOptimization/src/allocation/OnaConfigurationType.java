...
public final class OnaConfigurationType {
	...
	public static List<Task> generateTasks(Map<String, List<RecipeInfo>> recipeInfo, String[] resourceNames) {
		presetup();
	...
	public static ConfigurationType configurationType(Map<String, List<RecipeInfo>> recipeInfo, String[] resourceNames,
		...
		final ConfigurationType ct = makeConfigurationType(recipeInfo, resourceNames, recipeAndResourceToEnergy,
				recipeAndResourceToMontary, recipeAndResourceToProcessingTime, null,
				recipeAndResourceNameToPreemptionPoints, isMultiobjective, random);

		return ct;
	}

	public static ConfigurationType shallowConfigurationType(List<Task> tasks, Map<String, List<RecipeInfo>> recipeInfo,
			String[] resourceNames, boolean isMultiobjective, Random random) {
		presetup();
		...
		final ConfigurationType ct = makeShallowConfigurationType(tasks, recipeInfo, resourceNames,
	...
	private static ConfigurationType makeShallowConfigurationType(List<Task> tasks,
		...
		// int minTimes = tasks.stream().map(t ->
		// Collections.min(t.computations)).collect(Collectors.toList());
		// int minTime = Collections.min(minTimes);
